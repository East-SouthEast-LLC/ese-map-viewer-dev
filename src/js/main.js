...
function adjustLayout() {
  ...
  const topOffset = headerHeight + 40; // a 40px buffer below the header
                ...
                if (townData) {
                    ...
                    Promise.all(layerPromises)
                        .then(() => {
                            ...
                            menuScript.src = 'https://east-southeast-llc.github.io/ese-map-viewer-dev/src/js/components/toggleable-menu.js?v=2';
